...
Combines a request with bounded, provenance-bearing evidence and memory into a
``ResearchContext``. Phase 4 builds the *data assembly boundary* only — no
sophisticated model-context optimizer. All content here is untrusted data; it
never carries control-plane meaning.
"""
